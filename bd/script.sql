...
ALTER TABLE `categoria_has_artigo`
  ADD CONSTRAINT `fk_categoria_has_artigo_categoria1` FOREIGN KEY (`idcategoria`) REFERENCES `categoria` (`idcategoria`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_categoria_has_artigo_artigo1` FOREIGN KEY (`idartigo`) REFERENCES `artigo` (`idartigo`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `foto`
  ADD CONSTRAINT `fk_foto_artigo1` FOREIGN KEY (`idartigo`) REFERENCES `artigo` (`idartigo`) ON DELETE NO ACTION ON UPDATE NO ACTION;
